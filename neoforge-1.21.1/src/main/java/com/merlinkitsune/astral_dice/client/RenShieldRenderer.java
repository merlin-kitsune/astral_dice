...
/**
 * 鼠鼠护盾(游戏大师立牌 ren)的**第三方可见**能量球护盾渲染(1.21.1 / NeoForge)。
 *
 ...
 *
 * <p>故条件源改为 {@link RenShieldVisibility} —— 由 {@code network.RenShieldStatePayload} 维护的
 * 全服护盾持有者镜像(服务端在护盾状态变化时广播、玩家登录时补发全量)。
 *
 ...
 *
 * <h2>性能</h2>
 * 只在本地玩家 ≤ {@link #MAX_DISTANCE} 格内、且带该效果的玩家上工作;无护盾时整段不 push/不取 buffer。
 */
