 ...
 *
 * <p>与 1.21.1 侧逐字等价，平台差异只有发包方式（{@link ModNetwork} 的 {@code SimpleChannel}）。
 *
 ...
 *
 * <p>登录时客户端缓存不可信，故登录/重生后 {@link #forceResend} 无条件重发一次。
 */
public final class StarCoinBalanceSync {
    ...
    private static void syncIfChanged(ServerPlayer player) {
        ...
        ModNetwork.sendToPlayer(player, new ModNetwork.StarCoinBalanceMessage(balance));
    }
