...
import com.merlinkitsune.starenginelib.event.EventEffect;
/**
 * 事件类型注册表。
...
public final class AstralEvents {
    ...
    public static void init() {
        register(new AstralEventType(
                new ResourceLocation(AstralDiceMod.MODID, "random_buff"),
                ctx -> {
        ...
        register(new AstralEventType(
                new ResourceLocation(AstralDiceMod.MODID, "reduce_armor"),
                ctx -> {
    ...
    public static void register(String id, EventEffect effect) {
        register(new AstralEventType(new ResourceLocation(AstralDiceMod.MODID, id), effect));
    }
}
