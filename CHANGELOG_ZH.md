...
- 文本/手册整理:合并本地修改至双版本——Moses 手册被动页合并、移除 integration 第 4 页(千咒刻印)、Pandaman tooltip 嘲讽改为蓝色;同时移除肉弹战车立牌 tooltip 两个计数器之间的多余空行;枪匠立牌 tooltip 被动技能标题删除“弱点识破”,仅保留“精密技巧”;再统一 6 处材料/筹码文案(再生试剂/导电线材/星币尘 手册描述、大碗炖肉/书签 手册描述、星币尘 tooltip)——措辞与效果及流派体系对齐(「研磨而成的粉末」→「制成的合金材料」、「导引电流」→「储存和传递能量」、移除「(无上限、无计数)」),英文与 1.20.1 同步。
