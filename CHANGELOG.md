...
- 立牌主动技能 ActionBar 提示重构:新建独立响应事件 `SignActiveTriggeredEvent`,占星师/秘密侦探/大侦探等自带反馈的立牌在立牌类中注册自身提示;未注册的立牌(大当家/扫地机/忍者/史莱姆/看板/护法/骇客/上班族/吸血鬼/经商/调查员)触发主动时显示默认提示「<立牌名>：主动技能已启动！」(仅 1.21.1)。 / Sign-active ActionBar feedback refactored: a dedicated response event `SignActiveTriggeredEvent` was added; signs with their own feedback (Haiqing, Bonnie, Fanny) register their prompts in their sign classes; unregistered signs (Fen, Jasmine, Komachi, Lulu, Mimi, Misaki, Nancy Lu, Padman, Papara, Parunan, Rin) show the default "<Sign>: Active skill started!" (1.21.1 only).
