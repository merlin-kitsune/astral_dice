...
- No-stream chip display order adjusted: Member Recommendation / Bookmark / Piggy Bank / Smart Watch / Whetstone now sit together immediately before Adrenaline - High-Grade (their relative order is unchanged and every other entry keeps its position; the creative tab and the Patchouli "No-stream Chips" chapter were reordered together so both views stay in sync) (both loaders).
