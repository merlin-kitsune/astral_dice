...
> - ⏳ **人偶师 hanna**（4 号）—— **尚未实施**；`人偶完成.png` / `人偶制作.png` 用途仍待裁决（见 §3）。⚠️ sherry 的被动「挚友守护」已按注册 id 字符串 `astral_dice:hanna_sign` 预留判定 ⇒ hanna 一落地该被动**自动生效**，无需回头改 sherry。
