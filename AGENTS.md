...
| 蛟龙 mamushi | **待裁决**(2026-09-27 本批**只落资产与注册**:未覆写 `handleUse`、无被动钩子 ⇒ 主动按 `BaseSignItem` 默认实现打 WARN 并 `InteractionResultHolder.fail`,不进冷却、不施加任何效果) | **待裁决** |
