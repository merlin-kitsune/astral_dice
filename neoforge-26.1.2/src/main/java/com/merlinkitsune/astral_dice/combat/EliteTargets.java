...
public final class EliteTargets {
    ...
    public static boolean isEliteOrBoss(LivingEntity entity) {
        ...
        // ⚠️ 26.1.2 平台差异：CompoundTag#getBoolean(String) 返回 Optional<Boolean>（1.21.1 返回 boolean）
        // ⇒ 改用语义等价的 getBooleanOr(key, false)，避免每处再解包 Optional
        CompoundTag persistent = entity.getPersistentData();
        return persistent.getBooleanOr(APOTH_BOSS_KEY, false) || persistent.getBooleanOr(APOTH_MINIBOSS_KEY, false);
    }
}
