...
import com.merlinkitsune.astral_dice.item.sign.HannaSignItem;
...
import com.merlinkitsune.astral_dice.item.sign.SherrySignItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> OBSIDIAN_DICE = registerItem("obsidian_dice",
            props -> new com.merlinkitsune.astral_dice.item.dice.ObsidianDiceItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.epic())));
    ...
    public static final DeferredItem<Item> NETHER_STAR_DICE = registerItem("nether_star_dice",
            props -> new com.merlinkitsune.astral_dice.item.dice.NetherStarDiceItem(props
                    .stacksTo(1)
    ...
    public static final DeferredItem<Item> CUTTER_BLADE_CHIP = registerItem("cutter_blade_chip",
            props -> new CutterBladeChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.legendary())));
    ...
    public static final DeferredItem<Item> HAND_FAN_BIG_CHIP = registerItem("hand_fan_big_chip",
            props -> new FanBigChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.epic())));
    ...
    public static final DeferredItem<Item> EIGHT_SIDED_DICE = registerItem("eight_sided_dice_chip",
            props -> new EightSidedDiceChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.rare())));
    ...
    public static final DeferredItem<Item> SPEED_SKATES_LOW = registerItem("speed_skates_low_chip",
            props -> new SpeedSkatesChipItem(props
                    .stacksTo(1)
    ...
    public static final DeferredItem<Item> MOTO_HELMET_LOW = registerItem("moto_helmet_low_chip",
            props -> new MotoHelmetChipItem(props
                    .stacksTo(1)
    ...
    public static final DeferredItem<Item> SANDWICH_LOW = registerItem("sandwich_low_chip",
            props -> new SandwichChipItem(props
                    .stacksTo(1)
    ...
    public static final DeferredItem<Item> ADRENALINE_LOW = registerItem("adrenaline_low_chip",
            props -> new AdrenalineChipItem(props
                    .stacksTo(1)
    ...
    public static final DeferredItem<Item> STAR_COIN_HAMMER = registerItem("star_coin_hammer_chip",
            props -> new StarCoinHammerChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.legendary())));
    ...
    public static final DeferredItem<Item> CURSED_SWORD = registerItem("cursed_sword_chip",
            props -> new CursedSwordChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.rare())));
    ...
    public static final DeferredItem<Item> ELECTRIC_SWORD = registerItem("electric_sword_chip",
            props -> new ElectricSwordChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.rare())));
    ...
    public static final DeferredItem<Item> CURRENT_CORE_CHIP = registerItem("current_core_chip",
            props -> new CurrentCoreChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.epic())));
    ...
    public static final DeferredItem<Item> BIG_BOWL_STEW_CHIP = registerItem("big_bowl_stew_chip",
            props -> new BigBowlStewChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.legendary())));
    ...
    public static final DeferredItem<Item> SMART_WATCH_CHIP = registerItem("smart_watch_chip",
            props -> new SmartWatchChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.epic())));
    ...
    public static final DeferredItem<Item> RAILGUN_CHIP = registerItem("railgun_chip",
            props -> new RailgunChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.legendary())));
    ...
    public static final DeferredItem<Item> PRIMORDIAL_CORE_CHIP = registerItem("primordial_core_chip",
            props -> new PrimordialCoreChipItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.legendary())));
    ...
    public static final DeferredItem<Item> HAIQING_SIGN = registerItem("haiqing_sign",
            props -> new HaiqingSignItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.epic())));
    ...
    public static final DeferredItem<Item> NARDIS_SIGN = registerItem("nardis_sign",
            props -> new NardisSignItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.rare())));
    ...
    public static final DeferredItem<Item> MAMUSHI_SIGN = registerItem("mamushi_sign",
            props -> new MamushiSignItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.legendary())));
    ...
    public static final DeferredItem<Item> SHERRY_SIGN = registerItem("sherry_sign",
            props -> new com.merlinkitsune.astral_dice.item.sign.SherrySignItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.bizarre())));
    ...
    public static final DeferredItem<Item> HANNA_SIGN = registerItem("hanna_sign",
            props -> new com.merlinkitsune.astral_dice.item.sign.HannaSignItem(props
                    .stacksTo(1)
                    .rarity(AstralRarities.bizarre())));
     ...
     * 注册物品。
     *
     * <p><b>26.1.2 迁移说明(必须沿用本形式)</b>:NeoForge 26.1.x 起 {@code Item.Properties}
     * 必须携带物品 id({@code Item.Properties#setId(ResourceKey)}),而
     * {@code DeferredRegister.Items#register(String, Supplier)} <b>不会</b>自动注入 id ——
     * 用旧写法({@code ITEMS.register(name, () -> new XxxItem(new Item.Properties()...))})
     * 构造 {@code Item} 时会在注册阶段直接抛
     * {@code NullPointerException: Item id not set}(原版 {@code Item} 构造器经
     * {@code Item.Properties#itemIdOrThrow} 推导默认描述 id)。
     *
     * <p>故统一改为 {@code registerItem(name, props -> new XxxItem(props...))}:经由 NeoForge 的
     * {@code DeferredRegister.Items#registerItem(String, Function)} 重载,
     * 物品构造器收到的 properties 已由加载器注入 {@code Registries.ITEM} 的 id。
     * 新增物品请照抄这一形式:属性链写在传进来的 {@code props} 上,
     * <b>不要</b>再自己 {@code new Item.Properties()}(也不要用 {@code XxxItem::new} 方法引用形式 ——
     * 构造器带额外参数时会被逗号截断)。
     */
    public static <T extends Item> DeferredItem<T> registerItem(String name,
            java.util.function.Function<Item.Properties, ? extends T> factory) {
