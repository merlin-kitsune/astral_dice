...
public class AtmChipItem extends BaseChipItem {
    ...
    public void onEquip(SlotContext slotContext, ItemStack prevStack, ItemStack stack) {
        ...
        // 装备时星光 +1(上限由 StarLightManager 统一管理);走统一发放入口 —— 把**实际**抬升量记账,
        // 卸除时按账本严格扣回(见 StarLightManager#revokeStarlightOnUnequip)。
        StarLightManager.grantStarlightOnEquip(player, StarLightManager.GRANT_BIT_ATM, 1);
    }
    ...
    protected void onChipUnequip(Player player, ItemStack stack) {
        ...
        StarLightManager.revokeStarlightOnUnequip(player, StarLightManager.GRANT_BIT_ATM);
    }
}
